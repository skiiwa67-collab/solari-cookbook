...
- Signed weathered vellum plates (Darren chips) — live next orbital from public Launch Library 2. Hover breeze follows the pointer; click turns the leaf. If LL2 fails, SAMPLE last-known Starlink Group 15-23. Not Solari. No Mechazilla on 4E.
